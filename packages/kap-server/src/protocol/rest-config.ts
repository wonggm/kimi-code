...
export const configResponseSchema = z.object({
  ...
  subagent_efforts: z.record(z.string(), z.string()).optional(),
  subagent_compaction: z.record(z.string(), z.unknown()).optional(),
...
>>>>>>> 60f0753fa (feat(agent-core-v2,kap-server,web): per-profile subagent compaction overrides)
