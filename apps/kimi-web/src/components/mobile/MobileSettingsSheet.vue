    ...
    <template v-else-if="view === 'providers'">
      ...
      <template v-else>
        <div v-for="[id, provider] in customProviders.providers" :key="id" class="arch-row">
          ...
          <form v-if="customProviders.editingId === id" class="provider-form mobile-provider-form" @submit.prevent="customProviders.save">
            <label class="provider-field">{{ t('settings.customProviderId') }}<input v-model="customProviders.form.id" disabled /></label>
      ...
      <form v-if="customProviders.adding" class="provider-form mobile-provider-form" @submit.prevent="customProviders.save">
        <label class="provider-field">{{ t('settings.customProviderId') }}<input v-model="customProviders.form.id" :disabled="configSaving" /></label>
        <label class="provider-field">{{ t('settings.customProviderType') }}<input v-model="customProviders.form.type" :disabled="configSaving" /></label>
        <label class="provider-field">{{ t('settings.customProviderBaseUrl') }}<input v-model="customProviders.form.baseUrl" :disabled="configSaving" type="url" /></label>
