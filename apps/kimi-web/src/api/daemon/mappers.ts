...
export function toAppSessionUsage(wire: WireSessionUsage): AppSessionUsage {
  return {
    ...
    cacheReporting: wire.cache_reporting,
    cacheHitRateLast: wire.cache_hit_rate_last,
    cacheHitRateRecent: wire.cache_hit_rate_recent,
    cacheRecentRequests: wire.cache_recent_requests,
    cacheHitRateSession: wire.cache_hit_rate_session,
...
export function toAppSession(wire: WireSession): AppSession {
  return {
    ...
    emoji: wire.emoji ?? (typeof wire.metadata['emoji'] === 'string' ? wire.metadata['emoji'] : undefined),
    pinned: wire.pinned ?? (typeof wire.metadata['pinned'] === 'boolean' ? wire.metadata['pinned'] : undefined),
...
export function toAppTask(wire: WireTask): AppTask {
  return {
    ...
    thinkingEffort: wire.thinking_effort ?? wire.thinkingEffort,
    model: wire.model,
...
export function toAppConfig(wire: WireConfig): AppConfig {
  ...
  return {
    ...
    loopControl: wire.loop_control as AppConfig['loopControl'],
