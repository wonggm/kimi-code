      ...
      ui-monospace, "SF Mono", Menlo, Consolas, monospace;</pre></div>
            ...
            <table class="dt">
              ...
              <tbody>
                ...
                <tr><td class="tk">--lg-edge</td><td class="val">9% text (light) / 14% (dark), read by no rule</td><td>The contour hairline the material used to draw. Every rule that read it is gone, so nothing paints it now; <code>prefers-contrast: more</code> still re-declares it next to <code>--lg-shadow</code>.</td></tr>
